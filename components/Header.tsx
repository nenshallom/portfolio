      ...
      */}
      ...
      >
        ...
        <nav className="flex flex-col gap-6">
          ...
          <Link href="/" onClick={() => setIsMenuOpen(false)} className="group border border-primary/30 p-6 rounded-xl bg-gray-900/50 hover:border-primary transition flex flex-col gap-2">
            <div className="flex items-center gap-3 text-white font-bold text-lg">
              <Sun size={20} className="text-primary"/> HOME
            </div>
            <p className="text-xs text-gray-400 pl-8">Return to the Amazing Home Page</p>
          </Link>

          <Link href="/cv" onClick={() => setIsMenuOpen(false)} className="group border border-primary/30 p-6 rounded-xl bg-gray-900/50 hover:border-primary transition flex flex-col gap-2">
            <div className="flex items-center gap-3 text-white font-bold text-lg">
              <FileText size={20} className="text-primary"/> CV
            </div>
            <p className="text-xs text-gray-400 pl-8">View my CV professionally</p>
          </Link>

          <Link href="/ai" onClick={() => setIsMenuOpen(false)} className="group border border-primary/30 p-6 rounded-xl bg-gray-900/50 hover:border-primary transition flex flex-col gap-2">
            <div className="flex items-center gap-3 text-white font-bold text-lg">
              <Bot size={20} className="text-primary"/> ASK ME?
            </div>
            <p className="text-xs text-gray-400 pl-8">Let AI Answer Questions about me</p>
          </Link>
        </nav>
